...
Please do not open a public issue for a security problem. Use the "Report a vulnerability" button under this repository's Security tab instead.
...
mise run ci           # lint + typecheck + test — must pass before you push
```
